...
import usdexport_ui
from qn_maya.mayaAssetUtils import usdAssetExport
reload(usdexport_ui)
...
class MyWin(QWidget):
    def __init__(self,parent=None):
        ...
        self.setWindowTitle(u"千鸟/资产导出")
        self.ui.Camera.setVisible(False)
        self.ui.CameraPick.setVisible(False)
        self.ui.start_frame.setVisible(False)
        self.ui.end_frame.setVisible(False)
        self.ui.display_color.setVisible(False)
        self.ui.material.setVisible(False)
        self.ui.uv.setVisible(False)
        self.ui.subdiv.setVisible(False)
    ...
    def run(self):
        ...
        if a[0] != "":
            Mthread.executeInMainThreadWithResult(usdAssetExport,a[0])
