...
typedef void(*GetAssetTexture)(const char* usd_path, std::map<std::string, std::string>& images);
...
bool GetAssetTexture_DLL(const char* usd_path, std::map<std::string, std::string>& images)
{
